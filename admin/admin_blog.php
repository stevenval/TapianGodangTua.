...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-darkmary">List Of Blog</h6>
        </div>
        <div class="card-body">

            <div class="table-responsive">

                <a class="btn btn-primary mb-3" href="add_blog.php" role="button">Add Blog</a>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($ambil as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo "imgs/" . $row['gambar']; ?>" width="400" height="200">
                                </td>
                                <td>
                                    <?php echo $row["waktu"]; ?>
                                </td>
                                <td><a class="btn btn-primary " href="edit_blog.php?id=<?php echo $row["id_blog"] ?>"
                                    ...
                                    <a class="btn btn-primary mt-4" href="del_blog.php?id=<?php echo $row["id_blog"] ?>"
                                        .onclink="return confirm('anda yakin ingin menghapus data ini?'" role="button"
