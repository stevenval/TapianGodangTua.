...
$id=$_GET["id"];
$data = query("SELECT * FROM tb_fasilitas WHERE id_fasilitas = $id")[0];
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-darkmary">Edit Facility</h6>
        </div>
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <div class="mb-3">
                    ...
                    name="nama_fasilitas" value="<?php echo $data["nama_fasilitas"]?>">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Description</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" 
                    name="keterangan" value="<?php echo $data["keterangan"]?>"> </textarea>
                </div>
                <div class="mb-3">
