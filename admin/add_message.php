...
if (isset($_POST["submit"])) {
	if (simpan($_POST) > 0) {
		echo "
				<script>
				alert('Data messege Successfully added');
		...
		echo "
				<script>
				alert('Data messege failed to add');
				document.location.href='admin_messege.php';
				</script> ";
            ...
            <div class="table-responsive">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                        placeholder="Name of Facility" name="nama_pengirim">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Email</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                        placeholder="Name of Facility" name="email">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Subjek</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                        placeholder="Name of Facility" name="subjek">
                </div>
                <div class="mb-3">
